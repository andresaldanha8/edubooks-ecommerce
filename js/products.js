...
// Importa função addToCart sobrescrevendo para garantir 1 item por vez
// eslint-disable-next-line
if (!window.addToCart) {
    const script = document.createElement('script');
    script.src = 'js/add-to-cart-single.js';
...
const products = [
    {
        ...
        description: "Atividade educativa onde as crianças completam os nomes dos animais, desenvolvendo vocabulário e escrita.",
        price: 1.00,
    ...
    {
        id: 3,
        title: "O Amor de DEUS - START",
        description: "Ensine sobre o amor incondicional de Deus através de atividades tocantes e educativas.",
        price: 1.00,
        image: "img/produto-3.png"
    },
    {
        id: 4,
        title: "ATIVIDADES COM SÍLABAS",
        description: "Desenvolva a consciência fonológica das crianças através de exercícios progressivos.",
        price: 1.00,
        image: "img/produto-4.png"
    },
    {
        id: 5,
        title: "LIVRO DE ATIVIDADES CRISTÃS",
        description: "Coleção completa de atividades que ensinam valores cristãos de forma divertida.",
        price: 1.00,
        image: "img/produto-5.png"
    },
    {
        id: 6,
        title: "Números até 100",
        description: "Ensine matemática básica através de atividades lúdicas e progressivas.",
        price: 1.00,
        image: "img/produto-6.png"
    },
    {
        id: 7,
        title: "SOMAR",
        description: "Aprenda adição de forma divertida com exercícios visuais e práticos.",
        price: 1.00,
        image: "img/produto-7.png"
    },
    {
        id: 8,
        title: "Produção de Textos",
        description: "Desenvolva habilidades de escrita criativa através de técnicas e exercícios.",
        price: 1.00,
        image: "img/produto-8.png"
    }
];

// Compatibilidade com sistema antigo
// Exporta products para uso global (checkout)
...
const ebooks = [
    ...
    },
    {
        ...
        description: "Versão especial do alfabeto bíblico desenvolvida especialmente para crianças menores, com atividades lúdicas que combinam diversão, fé e aprendizado das letras.",
        price: 1.00,
        category: "igreja",
        image: "images/img03.png",
        fallbackEmoji: "�️",
        features: ["Alfabeto cristão", "Atividades lúdicas", "Desenvolvimento da fé", "Aprendizado das letras"],
        downloadFormats: ["PDF"],
        ageRange: "2-6 anos"
    },
    {
        ...
        description: "Atividade educativa onde as crianças completam os nomes dos animais, desenvolvendo vocabulário, escrita e reconhecimento dos bichinhos de forma divertida.",
        price: 1.00,
        category: "escolares",
        image: "images/img04.png",
        fallbackEmoji: "🦁",
        features: ["Desenvolvimento do vocabulário", "Prática de escrita", "Reconhecimento de animais", "Coordenação motora fina"],
        downloadFormats: ["PDF"],
        ageRange: "4-8 anos"
    },
    {
        id: 5,
        name: "O Amor de DEUS - START",
        description: "Livro de colorir especial que ensina sobre o amor incondicional de Deus através de desenhos tocantes, combinando arte, fé e desenvolvimento da criatividade infantil.",
        price: 1.00,
        category: "igreja",
        image: "images/img05.png",
        fallbackEmoji: "❤️",
        features: ["Amor incondicional", "Desenhos cristãos", "Desenvolvimento espiritual", "Coordenação motora"],
        downloadFormats: ["PDF"],
        ageRange: "3-10 anos"
    },
    {
        id: 6,
        name: "Aprendendo a Orar",
        description: "Guia prático e carinhoso que ensina as crianças sobre a importância e o poder da oração, com atividades diversificadas para desenvolver a vida espiritual desde cedo.",
        price: 1.00,
        category: "igreja",
        image: "images/img06.png",
        fallbackEmoji: "🙏",
        features: ["Guia de oração", "Desenvolvimento espiritual", "Momentos especiais", "Conexão com Deus"],
        downloadFormats: ["PDF"],
        ageRange: "4-12 anos"
    },
    {
        id: 7,
        name: "Colorindo com Propósito - Atividades",
        description: "Livro de colorir especial com atividades bíblicas direcionadas, onde cada desenho carrega um propósito educativo e espiritual para o desenvolvimento cristão infantil.",
        price: 1.00,
        category: "igreja",
        image: "images/img07.png",
        fallbackEmoji: "🎨",
        features: ["Colorir com propósito", "Atividades direcionadas", "Desenvolvimento espiritual", "Arte cristã"],
        downloadFormats: ["PDF"],
        ageRange: "4-10 anos"
    },
    {
        ...
        description: "Compilação completa de atividades bíblicas variadas para entretenimento e aprendizado cristão, desenvolvendo valores e fé através de exercícios práticos e envolventes.",
        price: 1.00,
        category: "igreja",
        image: "images/img08.png",
        fallbackEmoji: "📚",
        features: ["Atividades variadas", "Aprendizado cristão", "Desenvolvimento da fé", "Exercícios práticos"],
        downloadFormats: ["PDF"],
        ageRange: "4-12 anos"
    }
];
// Exporta ebooks para uso global (carrinho e checkout)
...
function loadFeaturedProducts() {
    ...
    container.innerHTML = featuredEbooks.map(ebook => createProductCard(ebook)).join('');
        // Garante que os botões 'Comprar' funcionem na index
